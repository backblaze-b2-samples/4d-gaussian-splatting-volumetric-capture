...
Make 4D Gaussian Splatting Volumetric Capture the canonical identity across the shipped web app,
...
The web app and local API now ship under the 4D Gaussian Splatting Volumetric Capture identity.
